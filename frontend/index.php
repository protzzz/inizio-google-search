...
$url = BACKEND_URL . "/api/search" . "?q=" . urlencode($query) . "&num=" . $total . "&start=" . $start;
...
$downloadJsonUrl = $url . "&format=json";
  ...
  <main class="container">
    ...
    <?php if ($query !== ""): ?>
      <div class="short-info">
        ...
        | page=<?php echo $start; ?>
        | shown=<?php echo is_array($results["results"] ?? null) ? count($results["results"]) : 0; ?>
